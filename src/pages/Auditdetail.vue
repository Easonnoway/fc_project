<template>
    ...
    <el-card shadow="always" style="margin:80px 15%">
        <h2>二氧化碳总排放量：{{ myArray.reduce((accumulator, obj) => accumulator + obj.value, 0) }}吨</h2>
        <div id="CO2Value"> </div>
        <div id="CO2Value2"></div>
    </el-card>
    <el-card shadow="always" style="margin:80px 15%" v-show="moudleShow.show1 && fossilData.length > 0">
    ...
    <el-card shadow="always" style="margin:80px 15%" v-show="moudleShow.show2 && desulfurization.length > 0">
    ...
    <el-card shadow="always" style="margin:80px 15%" v-show="moudleShow.show3 && process.length > 0">
    ...
    <el-card shadow="always" style="margin:80px 15%" v-if="process_ceramic && process_ceramic[0]"
    ...
    <el-card shadow="always" style="margin:80px 15%" v-show="moudleShow.show4 && biomass.length > 0">
    ...
    <el-card shadow="always" style="margin:80px 15%" v-show="moudleShow.show5 && electricity.length > 0">
