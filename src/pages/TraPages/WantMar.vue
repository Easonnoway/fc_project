<template>
            ...
            <el-table-column align="right">
                <template #default="scope">
                    ...
                    <el-popconfirm width="220" @confirm="handleEdit(scope.$index, scope.row)" confirm-button-text="确定"
                        cancel-button-text="取消" icon-color="#626AEF" title="你确定要售出">
                        <template #reference>
                            <el-button size="small" type="success">售出</el-button>
                        </template>
                    </el-popconfirm>
                </template>
            </el-table-column>
    ...
    <el-dialog v-model="dialogFormVisible" title="请输入私钥" width="500">
